...
router.get("/getProducts/:categoryId", limitRequests(300, 100), productController.getProducts);
router.get("/getProduct/:id", limitRequests(300, 100), getByIdRules, validateRequest, productController.getProduct);
