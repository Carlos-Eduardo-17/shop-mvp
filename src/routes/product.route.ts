...
router.get("/", limitRequests(300, 150), productController.getProducts); // ?categoryId=
router.get("/:id", limitRequests(300, 150), getByIdRules, validateRequest, productController.getProduct);
