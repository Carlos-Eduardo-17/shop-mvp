...
router.post("/items", limitRequests(300, 40), requireAuth, addItemRules, validateRequest, cartController.addItem);
router.get("/", limitRequests(300, 50), requireAuth, cleaningRules,validateRequest, cartController.getCart);
router.delete("/item", limitRequests(300, 40), requireAuth, validateRequest, cartController.removeItem); // ?cartItemId= . IDs de recursos a modificar/eliminar van en el path
